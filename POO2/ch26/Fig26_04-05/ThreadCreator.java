...
//      Thread thread3 = new Thread( new PrintTask( "task3" ) );
      ...
      Thread thread1 = new Thread( new PrintTask( "task1", 1000) );
      Thread thread2 = new Thread( new PrintTask( "task2", 3000) );
      Thread thread3 = new Thread( new PrintTask( "task3", 6000) );
